...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_StateMachine_EStateMachineCompletionType_CRC() { return 868506021U; }
	UEnum* Z_Construct_UEnum_StateMachine_EStateMachineCompletionType()
	{
		...
		if (!ReturnEnum)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "Rejected.ToolTip", "Explicit failure - this state is specifically masked as failure/not-accept" },
			};
#endif
...
static struct FScriptStruct_StateMachine_StaticRegisterNativesFStateMachineResult
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FStateMachineResult_CRC() { return 2708741309U; }
	...
	IMPLEMENT_CLASS(USM_InputAtom, 3096899279);
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_DestinationState = { UE4CodeGen_Private::EPropertyClass::Object, "DestinationState", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080000000001, 1, nullptr, STRUCT_OFFSET(USM_BranchBase, DestinationState), Z_Construct_UClass_USM_State_NoRegister, METADATA_PARAMS(NewProp_DestinationState_MetaData, ARRAY_COUNT(NewProp_DestinationState_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_DestinationState,
			};
			static const FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
	...
	IMPLEMENT_CLASS(USM_BranchBase, 2706392875);
	...
	IMPLEMENT_CLASS(USM_Branch, 2012278511);
	...
	UFunction* Z_Construct_UFunction_USM_State_RunState()
	{
		...
		if (!ReturnFunction)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
				...
				{ "ModuleRelativePath", "Classes/SM_State.h" },
				{ "ToolTip", "Attempt to run the state with input from the given DataSource object. Will start reading input at DataIndex. Will decrement RemainingSteps and automatically fail after it hits 0." },
			};
#endif
	...
	UClass* Z_Construct_UClass_USM_State()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_USM_State_RunState, "RunState" }, // 3334486111
			};
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
				{ "IncludePath", "SM_State.h" },
			...
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SharedBranches_MetaData[] = {
				{ "Category", "SM_State" },
				{ "ModuleRelativePath", "Classes/SM_State.h" },
				{ "ToolTip", "Branches to other states. These are in priority order, so the first successful branch will be taken. These run after InstancedBranches." },
			};
#endif
			...
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_SharedBranches_Inner = { UE4CodeGen_Private::EPropertyClass::Object, "SharedBranches", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000000000, 1, nullptr, 0, Z_Construct_UClass_USM_BranchBase_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_InstancedBranches_Inner = { UE4CodeGen_Private::EPropertyClass::Object, "InstancedBranches", RF_Public|RF_Transient|RF_MarkAsNative, 0x0002000000080008, 1, nullptr, 0, Z_Construct_UClass_USM_BranchBase_NoRegister, METADATA_PARAMS(NewProp_InstancedBranches_Inner_MetaData, ARRAY_COUNT(NewProp_InstancedBranches_Inner_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(USM_State, 1125574399);
